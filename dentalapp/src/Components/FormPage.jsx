...
const FormPage = () => {
    return (
        <div className={"max-w-[700px] m-auto py-16 flex flex-col p-4"}>
            <form className={"w-full flex flex-col "} method={"POST"} encType={"multipart/form-data"} action="https://getform.io/f/3773d6e6-465b-4bed-8d00-f19a83305a64">
                ...
                <textarea className={"border"} name="message" id="" cols="20" rows="5" placeholder={"Message"}></textarea>
